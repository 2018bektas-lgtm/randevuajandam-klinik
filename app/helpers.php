...
if (! function_exists('site_nav')) {
    ...
    function site_nav(?array $doktor = null): array
    {
        ...
        // Klinik hakkında = vitrin çekirdeği (paket kilidi yok)
        ...
        // API paket filtresi boş içerik döner → menüde gizle
...
if (! function_exists('site_footer_nav')) {
    ...
    function site_footer_nav(?array $doktor = null): array
    {
        ...
        $defaults = [
            ['route' => 'frontend.hakkimda', 'label' => 'Hakkımızda'],
            ['route' => 'frontend.hekimler', 'label' => 'Hekimlerimiz'],
