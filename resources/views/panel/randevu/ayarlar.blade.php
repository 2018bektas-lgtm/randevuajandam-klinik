...
@section('icerik')
    ...
    <div id="tab-content-genel-ayarlar" class="tab-content">
        <div class="max-w-5xl">
            <div class="p-8 rounded-2xl bg-white border border-[#E5E7EB] shadow-[0_4px_24px_rgba(31,41,55,0.04)]">
                ...
                <form action="{{ route('panel.randevu-ayarlari.update') }}" method="POST" class="space-y-8">
                    @csrf
    ...
    <div id="tab-content-calisma-saatleri" class="tab-content hidden">
        <div class="max-w-6xl space-y-6">
            ...
            <form action="{{ route('panel.calisma-saatleri.update') }}" method="POST" class="space-y-6">
                @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    @foreach($izinler as $izin)
                                        <tr class="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <form action="{{ route('panel.randevu.izin-sil', $izin->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="space-y-6">
                <div class="p-8 rounded-2xl bg-white border border-[#E5E7EB] shadow-[0_4px_24px_rgba(31,41,55,0.04)]">
                    ...
                    <form action="{{ route('panel.randevu.izin-ekle') }}" method="POST" class="space-y-5">
                        @csrf
