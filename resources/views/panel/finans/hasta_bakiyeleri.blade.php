                        ...
                        <tr class="hover:bg-[#FAFAFA]/50 transition-colors">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex items-center justify-center gap-3">
                                    <a href="{{ route('panel.finans.gelirler', ['hasta_id' => $hasta->id]) }}" class="inline-flex items-center gap-1 text-xs font-bold text-[#C96A2B] hover:underline" title="Detaylı İşlemler">
