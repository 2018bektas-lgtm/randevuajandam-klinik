                ...
                @forelse($gelirKategorileri as $kategori)
                    <div class="flex items-center gap-3 px-6 py-3.5">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <form action="{{ route('panel.finans.kategoriler.toggle', $kategori->id) }}" method="POST" class="inline">
                                @csrf
                            ...
                            <form action="{{ route('panel.finans.kategoriler.destroy', $kategori->id) }}" method="POST" onsubmit="return confirm('Bu kategoriyi silmek istediğinize emin misiniz?')" class="inline">
                                @csrf @method('DELETE')
