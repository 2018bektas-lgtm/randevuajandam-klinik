...
@section('baslik', 'Yeni Hizmet Ekle - Hekim Paneli')
@section('sayfa_baslik', 'Yeni Hizmet Ekle')

@section('icerik')
<div class="mb-6">
    <a href="{{ route('panel.hizmetler') }}" class="inline-flex items-center gap-1 text-xs text-[#6B7280] hover:text-[#C96A2B] font-semibold transition-colors font-display">
...
<div class="bg-white rounded-2xl border border-[#E5E7EB] p-8 shadow-sm">
    <form action="{{ route('panel.hizmetler.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="ad" id="ad" value="{{ old('ad') }}" required placeholder="Ã–rn: DetaylÄ± Kardiyoloji Muayenesi..."
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative rounded-xl shadow-sm">
                        <input type="number" name="sure" id="sure" value="{{ old('sure', 30) }}" required min="1" max="1440" placeholder="30"
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative rounded-xl shadow-sm">
                        ...
                        <input type="number" name="fiyat" id="fiyat" value="{{ old('fiyat') }}" step="0.01" min="0" placeholder="0.00"
