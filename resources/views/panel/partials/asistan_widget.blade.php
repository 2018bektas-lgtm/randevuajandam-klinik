{{-- Klinik Paneli AI Asistan Widget --}}
<style>
    #ra-asistan-fab {
        position: fixed;
        bottom: 28px;
    ...
    .ra-header h4 { font-size: 14px; font-weight: 700; margin: 0; }
    .ra-header p  { font-size: 11px; opacity: .80; margin: 0; }
    ...
    .ra-hizli-baslik { font-size: 11px; color: #9CA3AF; margin-bottom: 2px; }
    .ra-hizli-btn {
        background: #fff;
...
(function () {
    ...
    const endpoint = '{{ route("panel.asistan.mesaj") }}';
