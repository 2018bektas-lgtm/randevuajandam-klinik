                    ...
                    <tr class="hover:bg-slate-50/50">
                        <td class="px-5 py-3.5">
                            ...
                            <div class="text-[10px] text-slate-400 mt-0.5">
                                ...
                                · {{ !empty($e->baslangic_at) ? \Illuminate\Support\Carbon::parse($e->baslangic_at)->format('d.m.Y H:i') : 'Tarih yok' }}
                            </div>
                        </td>
                        <td class="px-5 py-3.5">
                        ...
                        <td class="px-5 py-3.5">
                            <a href="{{ route('panel.egitimler.basvurular', $e->id) }}"
