                        ...
                        <tr class="hover:bg-slate-50/40 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <form action="{{ route('panel.faqs.toggle', $faq->id) }}" method="POST" class="inline">
                                        @csrf
                                    ...
                                    <form action="{{ route('panel.faqs.destroy', $faq->id) }}" method="POST" class="inline" onsubmit="return confirm('Bu soruyu silmek istediğinize emin misiniz?')">
                                        @csrf
                                        @method('DELETE')
