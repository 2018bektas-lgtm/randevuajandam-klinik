...
@section('baslik', 'Blog Yazısı Düzenle - Hekim Paneli')
@section('sayfa_baslik', 'Blog Yazısı Düzenle')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="baslik" id="baslik" value="{{ old('baslik', $blog->baslik) }}" required placeholder="Başlık girin..."
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div class="w-full h-44 bg-slate-50 rounded-2xl border border-dashed border-[#E5E7EB] flex items-center justify-center overflow-hidden relative group">
                            <img id="previewBlogImage" src="{{ $blog->resim ? media_url($blog->resim) : '' }}" alt="Önizleme" class="w-full h-full object-cover {{ $blog->resim ? '' : 'hidden' }}">
                ...
                <div class="bg-slate-50/50 rounded-2xl border border-[#E5E7EB] p-5 space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="meta_baslik" id="meta_baslik" value="{{ old('meta_baslik', $blog->meta_baslik) }}" placeholder="Arama motoru başlığı..."
                               class="w-full px-3.5 py-2.5 rounded-xl bg-white border border-[#E5E7EB] text-[#111827] focus:outline-none focus:border-[#C96A2B] focus:ring-1 focus:ring-[#C96A2B] text-xs transition-all">
                    </div>
